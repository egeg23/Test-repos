...
test('решение по языкам зафиксировано в правилах проекта', () => {
  const rules = readFileSync(join(root, '..', 'CLAUDE.md'), 'utf8');
  assert.ok(/русский и английский/.test(rules),
    'потеряно решение делать последующие игры на двух языках');
});
