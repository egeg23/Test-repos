...
const RU = {
  ...
  how_to: 'Как играть',
  how_lotto: 'Нажмите на выпавшее число, пока его не сменил следующий бочонок',
  how_master: 'Поставьте бочонок в любую свободную клетку',
  how_drum: 'Возьмите один бочонок из трёх. Два других вернутся в мешок',
  how_rules: 'За что дают очки',
  how_rows: 'Строка: числа по возрастанию слева направо',
  how_cols: 'Столбец: числа из одного столбца карточки лото',
  how_diags: 'Диагональ: числа одной чётности',
  how_hint: 'Цифра в углу клетки — сколько даст бочонок именно здесь',
  how_ladder: 'Правила открываются по одному: строки, затем столбцы, затем диагонали',
  how_more: 'Чем длиннее совпадение, тем больше очков',
...
const EN = {
  ...
  play_free: 'Free game',
  how_to: 'How to play',
  how_lotto: 'Tap the called number before the next barrel replaces it',
  how_master: 'Place the barrel in any empty square',
  how_drum: 'Take one barrel of three. The other two go back into the bag',
  how_rules: 'What scores points',
  how_rows: 'Row: numbers ascending left to right',
  how_cols: 'Column: numbers from one lotto card column',
  how_diags: 'Diagonal: numbers of the same parity',
  how_hint: 'The small number in a corner is what the barrel gives there',
  how_ladder: 'Rules unlock one at a time: rows, then columns, then diagonals',
  how_more: 'The longer the match, the more points',
...
const TR = {
  ...
  how_lotto: 'Çıkan sayıya, bir sonraki fıçı gelmeden dokunun',
  how_master: 'Fıçıyı herhangi bir boş kareye koyun',
  how_drum: 'Üç fıçıdan birini alın. Diğer ikisi torbaya geri döner',
  how_rules: 'Puan neyden gelir',
  how_rows: 'Satır: soldan sağa artan sayılar',
  how_cols: 'Sütun: tombala kartının aynı sütunundan sayılar',
  how_diags: 'Çapraz: aynı tek veya çift sayılar',
  how_hint: 'Karenin köşesindeki küçük sayı, fıçının orada vereceği puandır',
  how_ladder: 'Kurallar sırayla açılır: satırlar, sonra sütunlar, sonra çaprazlar',
  how_more: 'Eşleşme ne kadar uzunsa puan o kadar yüksek',
