...
export const DEFAULT_SAVE = {
  v: 1,
  runs: 0,              // сыгранных партий
  best: 0,              // лучший счёт «тихого ухода»
  spared: [],           // кого ни разу не подставили — единственная метапрогрессия
  history: [],          // последние 30 партий
  muted: false,
  // lang в сохранении не держим: игра только на русском
};
