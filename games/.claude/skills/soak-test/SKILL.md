...
**Output:** `games/<game>/docs/soak-test-[date]-[duration].md`
...
- `docs/game-concept.md` — intended session length (for comparison against
...
- Most recent file in `games/<game>/docs/qa-plan-*.md` — current sprint test coverage
...
`games/<game>/docs/soak-test-[date]-[duration].md`?"
...
4. File bugs from 'Issues Found' to `games/<game>/docs/bugs/`
