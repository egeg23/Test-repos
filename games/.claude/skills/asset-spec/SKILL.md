...
- `docs/systems-index.md` — extract every system listed
- All GDDs in `docs/` — extract: Visual/Audio Requirements sections, UI elements mentioned, VFX events, any named entities (characters, enemies, buildings, items)
- `docs/art/art-bible.md` — extract: any named visual categories, asset type expectations
...
### Required reads:
- **Art bible**: Read `docs/art/art-bible.md` — fail if missing:
...
- **system**: Read `docs/[target-name].md`. Extract the **Visual/Audio Requirements** section. If it doesn't exist or reads `[To be designed]`:
  > "The Visual/Audio section of `docs/[target-name].md` is empty. Either run `/design-system [target-name]` to complete the GDD, or describe the visual needs manually."
...
> **Art Bible**: docs/art/art-bible.md
> **Generated**: [date]
