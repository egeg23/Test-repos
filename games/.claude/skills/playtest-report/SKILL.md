...
Pass: the structured report content, game pillars and core fantasy (from `docs/game-concept.md`), the specific hypothesis being tested.
...
Ask: "May I write this playtest report to `games/<game>/docs/playtests/playtest-[date]-[tester].md`?"
